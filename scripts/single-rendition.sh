...
# Creates consumers
cat "$BASE_DIR/fifo-720p" | ../bin/go-ts-segmenter -p $UPLOAD_PATH -lf ../logs/segmenter720p.log -host $HOST_DST -manifestDestinationType 0 -mediaDestinationType 3 -f 720p_ -cf 720p.m3u8 &
PID_720p=$!
