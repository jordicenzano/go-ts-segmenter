...
func main() {
	...
	mg := manifestgenerator.New(*isCreatingChunks, *baseOutPath, *chunkBaseFilename, *targetSegmentDurS, manifestgenerator.ManifestTypes(*manifestTypeInt), *liveWindowSize, *lhlsAdvancedChunks)
